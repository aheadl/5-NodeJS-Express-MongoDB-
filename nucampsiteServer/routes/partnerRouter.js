...
partnerRouter
  ...
  .put(authenticate.verifyAdmin, authenticate.verifyAdmin, (req, res) => {
...
// })
// .get((req, res) => {
//   res.end(`Get partners: ${req.params.partnerId} completed`);
// })
// .post((req, res) => {
//   res.end(
...
// })
// .put((req, res) => {
//   res.end(`PUT operation ${req.params.partnerId} completed `);
// })
// .delete((req, res) => {
